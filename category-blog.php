...
<?php get_template_part( 'nav-thought' ); // Navigation bar ?>
    ...
    <div class="bottom-padded container">
      ...
      <h1 class="text-center mobile-only">Blog</h1>
      ...
      <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <div class="col-md-4">
          <div class="blog-post-preview blog-post<?php if ($j%2==0) { ?> yellow-border<?php } ?>">
            <a href="<?php the_permalink()?>"><div class="posts-view-featured-image" style="<?php if ( has_post_thumbnail() ) {?>background:url(<?php the_post_thumbnail_url( 'medium' ); ?>) no-repeat center center/cover; -webkit-background-size:cover; -moz-background-size:cover; -o-background-size:cover;<?php } else { ?>background:#434d69;<?php } ?>"></div></a>
