...
<nav class="navbar navbar-default text-uppercase">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php get_bloginfo( ‘template_url’ ); ?>/present">
    ...
    <nav class="navbar navbar-default text-uppercase nav-thought">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php get_bloginfo( ‘template_url’ ); ?>/blog"><img class="taylor-brand" src="<?php bloginfo('template_directory'); ?>/img/logo-white.png" alt="Taylor Hammond" /></a>
